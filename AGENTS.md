...
- A sole player eliminated in voting round 0 gets access to ДЛХ only after explicitly voting for another player when redirecting that vote to any other candidate still could not prevent the elimination. A self-vote, no vote, or a vote that could have created a tie or another leader does not grant ДЛХ. Its 0.5/0.8 bonus follows the regular ЛХ rule and is stored separately.
